...
static const char *fonts[]          = { "JetBrainsMono:size=13", "Font Awesome 6 Free Solid:size=13" };
static const char dmenufont[]       = "JetBrainsMono:size=13";
static const char col_gray1[]       = "#1c1c1c";
static const char col_gray2[]       = "#222422";
static const char col_gray3[]       = "#cccccc";
static const char col_gray4[]       = "#000000";
static const char col_cyan[]        = "#2c4d23";
...
static const char *dmenucmd[] = { "rofi", "", "-icon-theme" "Papirus", "-show-icons", NULL };
static const char *termcmd[]  = { "alacritty", NULL };
static const char *flameshot[] = { "flameshot", "gui", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          SHCMD("rofi -combi-modi run,drun,ssh -theme /usr/share/rofi/themes/Arc-Dark.rasi -show combi -icon-theme Papirus -show-icons") },
...
/*	{ 0,             	    XK_Alt;XK_Tab, zoom;focusstack,{.0} {.i = +1} }, */

	{ MODKEY,                       XK_n,      togglealttag,   {0} },
	{ MODKEY|ShiftMask,		XK_m,	   spawn,	   SHCMD("dwmmake.sh") },
	{ MODKEY|ShiftMask,		XK_s,      spawn,	   SHCMD("steam") },	
	{ MODKEY|Mod1Mask,		XK_p,	   spawn,	   SHCMD("poweroff") },
	{ MODKEY|ShiftMask,		XK_r,	   spawn,	   SHCMD("reboot") },
	{ MODKEY|ShiftMask,		XK_h,	   spawn,	   SHCMD("systemctl hybrid-sleep") },
	{ Mod1Mask,			XK_Tab,	   alttab,	   {.i = -2} },
	{ MODKEY|ShiftMask,		XK_v,	   spawn,	   SHCMD("nmcli con up id Hetzner") },
